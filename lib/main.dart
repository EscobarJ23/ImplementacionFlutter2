...
import 'package:implementacionflutter/booton.dart';
import 'package:implementacionflutter/models/todo-item.dart';
import 'package:implementacionflutter/services/db.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'SQLite Flutter'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: BottomNavWicom(
          index: 0,
        ),
